<!doctype html>
 ...
 <head>
 <title>Online Event Management System - Admin Dashboard</title>
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total New Registration</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-3">
...
?> 
                                    ...
                                    <p class="font-w600 text-white">Total Approved Registration</p>
                                </div>
                            </a>
                        </div>
...
?>
                                    ...
                                    <p class="font-w600 text-white">Total Cancelled Registration</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-md-4 col-xl-4">
