                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">OEMS</span>|<span class="font-size-xl text-primary">ADMIN</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-note"></i><span class="sidebar-mini-hide">Registration</span></a>
                                    <ul>
                                        <li>
                                            <a href="new-booking.php">New Registration</a>
                                        </li>
                                        <li>
                                            <a href="approved-booking.php">Approved Registration</a>
                                        </li>
                                        <li>
                                            <a href="cancelled-booking.php">Cancelled Registration</a>
                                        </li>
                                        <li>
                                            <a href="all-booking.php">All Registration</a>
                                        </li>
                     ...
                     <li>
                                    <a href="booking-search.php"><i class="si si-magnifier"></i><span class="sidebar-mini-hide">Event Search</span></a>
