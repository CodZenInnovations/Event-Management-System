...
<html lang="en">
<head>
<title>Online Event Management System|| Home Page
</title>
				...
				<div class="container">
					<div class="w3-banner-info">
						<div class="w3l-banner-text">
							<h2>Event'S Hub</h2>
							<p>Join for better Experience</p>
						</div>
					</div>
				</div>
			</div>
            ...
            <div class="col-md-4 wthree-bottom-grid">
                <div class="w3-agileits-bottom-left">
                    <div class="w3-agileits-bottom-left-text">
                        <h3>Turning Moments into Milestones.</h3>
                        <p>Our mission is to celebrate life’s significant events in style.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 wthree-bottom-grid">
