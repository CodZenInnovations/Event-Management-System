...
$sql="insert into tblbooking(BookingID,ServiceID,UserID,BookingFrom,EventType,Numberofguest,Message)values(:bookingid,:bid,:uid,:bookingfrom,:eventtype,:nop,:message)";
...
<html lang="en">
<head>
<title>Online Event Management System | Book Events</title>
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Number of Student:</label>
                                    <div class="col-md-10">
